...
#alias p='git pull origin'                       # ex: p
#alias h='git log --pretty=oneline -20'          # ex: h
#alias s='git status'                            # ex: s
#alias b='git branch'                            # ex: b
#alias d='git diff HEAD'                         # ex: d
#alias rename="git branch -m"                    # ex: rename my-branch my-new-branch
#alias del='git branch -D'                       # ex: del old-branch
alias moveover='git checkout -b'                # ex: moveover my-new-branch
#alias push='git push origin HEAD'               # ex: push
#alias ac="git add -A . && git commit"           # ex: ac
#alias Ac='git add -A . && git commit --amend'   # ex: Ac
#alias add='git add -A'                          # ex: add .
#alias Add='git add -A .'                        # ex: Add
alias undoedit='git checkout --'                # ex: undoedit path/to/file
alias Undoedit='git checkout -- .'              # ex: Undoedit
#alias com='git commit'                          # ex: com
...
setopt auto_cd         # if I type a directory without 'cd', zsh automatically
                         # cds into it
...
PROMPT='%{$fg[green]%}%n%{$reset_color%}@%{$fg[cyan]%}%m %{$fg[blue]%}%* %{$fg[red]%}%~ %{$reset_color%}$(git_super_status) %# '
